    ...
    switch (this.exercisePhase) {
      ...
      case ExercisePhase.ERR_3:
        ...
        descriptionA = 'Has tenido algún fallo. Vamos a intentar recordar un poco mejor donde están situadas las ventanas abiertas ' +
          ...
          ' de la primera fila y la segunda está en el cuadrado ' + this.positionsExerciseService.getCorrectPositions(this.actualBuilding)[1] +
      ...
      case ExercisePhase.ERR_4:
        ...
        descriptionA = 'Has tenido algún fallo. Vamos a intentarlo otra vez. Ahora te voy a dar otra ayuda que seguramente te va ' +
          ...
          'En la segunda fila, la ventana abierta está en el cuadrado ' + this.positionsExerciseService.getCorrectPositions(this.actualBuilding)[1] +
          ', ¿ves? En la tercera, la ventana abierta está en el cuadrado ' + this.positionsExerciseService.getCorrectPositions(this.actualBuilding)[2] +
          '. En la cuarta fila, la ventana está en el cuadrado ' + this.positionsExerciseService.getCorrectPositions(this.actualBuilding)[3] +
          ' Y, en la última fila, la ventana está en cuadrado ' + this.positionsExerciseService.getCorrectPositions(this.actualBuilding)[4] +
